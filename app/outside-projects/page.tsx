    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-teal-50/20 to-slate-50 py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-2">
              {SHOWCASE_FEATURES.map((item) => (
                ...
                >
                  <div className="absolute right-0 top-0 h-24 w-24 translate-x-6 -translate-y-6 rounded-full bg-gradient-to-br from-teal-400/10 to-teal-600/10 blur-2xl transition-transform group-hover:scale-150" />
                  <div className="relative">
                    <div className="mb-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 p-3 text-white shadow-lg shadow-teal-500/30">
                      {iconMap[item.icon]}
                    </div>
          ...
          <div className="space-y-6 rounded-3xl border-2 border-teal-100 bg-gradient-to-br from-white via-teal-50/30 to-white p-8 shadow-xl shadow-teal-500/5">
            <div className="inline-flex items-center gap-2 rounded-full bg-teal-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-teal-600">
            ...
            <ul className="space-y-4">
              {CHECKPOINTS.map((checkpoint, index) => (
                <li key={checkpoint} className="flex items-start gap-4">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-teal-500 to-teal-600 text-sm font-bold text-white shadow-lg shadow-teal-500/30">
                    {index + 1}
                  </span>
