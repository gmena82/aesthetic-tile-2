        ...
        <div className="prose prose-slate mt-8 max-w-none prose-headings:font-semibold prose-a:text-teal-600 hover:prose-a:text-teal-700">
          ...
          <div className="my-8 overflow-hidden rounded-2xl">
            ...
            <p className="mt-2 text-center text-sm text-slate-500">
              Celebrating our expansion to Groveland, Florida.
            </p>
          </div>

          <h2>Why Groveland?</h2>
          <p>
            Groveland and the surrounding Lake County area represent everything we love about Central Florida: a tight-
            knit community, beautiful homes, and homeowners who value quality craftsmanship. The region's growth has
            been remarkable, and we're excited to be part of that momentum.
          </p>

          <p>
            Our new location at <strong>1195 Greenley Ave, Groveland, FL 34736</strong> positions us perfectly to serve
            Groveland, Clermont, Minneola, Winter Garden, and the greater Orlando area with even faster response times
          ...
          <ul>
            ...
            <li>
              <Link href="/floor-tile-installation">Floor Tile Installation</Link> — Durable, beautiful flooring for any
              room
            </li>
            <li>
              <Link href="/fireplaces">Fireplace Surrounds</Link> — Statement-making focal points for your living space
            </li>
            <li>
          ...
          <p>
            ...
            <Link href="mailto:office@aesthetictile.com">office@aesthetictile.com</Link> to schedule a consultation. We
            offer free estimates and would love to discuss your next tile project!
          </p>
        </div>
