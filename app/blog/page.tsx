...
export const metadata: Metadata = {
  ...
  description:
    "Explore the Aesthetic Tile blog for expert tips on tile installation, design trends for kitchens and bathrooms, and project showcases from Central Florida.",
}
